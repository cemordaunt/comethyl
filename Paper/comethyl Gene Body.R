...
pdf("Testing/Gene Bodies/Module_Circos_Plot.pdf", width = 3.5, height = 3.5)
...
ggsave("Testing/Gene Bodies/Module_Region_Counts.pdf", plot = gg, dpi = 600, width = 5, height = 7,
       units = "in")
